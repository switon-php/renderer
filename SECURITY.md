...
Security fixes are provided for **currently supported release lines** of `switon/renderer` (`switon/renderer` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/renderer/security/advisories/new)
